...
declare type GetClient<
  Base extends object,
  C extends RequiredArgs['client'],
  CP extends RequiredArgs['client'],
> = PatchFlat3<C, CP, Omit_2<Base, '$use'>>;
...
declare function getExtensionContext<T>(that: { [K: symbol]: T }): T;

declare type GetModel<
  Base extends object,
  M extends RequiredArgs['model'][string],
> = PatchFlat3<M, Base, {}>;
...
declare type GetResultPayload<
  Base extends object,
  R extends RequiredArgs['result'][string],
> = PatchFlat3<
  {},
  {
...
declare type MergeArgs<
  ExtArgs extends RequiredArgs,
  PrevExtArgs extends RequiredArgs,
  ModelNames extends string,
  ApplyAllModels extends boolean = true,
> = {
  result: '$allModels' extends keyof ExtArgs['result']
    ? ApplyAllModels extends true
      ? {
          [K in ModelNames]: PatchFlat3<
            ExtArgs['result'][K],
            ExtArgs['result']['$allModels'],
            PrevExtArgs['result'][K]
          >;
        }
      : {
          [K in
            | keyof ExtArgs['result']
            | keyof PrevExtArgs['result']]: PatchFlat3<
            ExtArgs['result'][K],
            PrevExtArgs['result'][K],
            {}
          >;
  ...
  model: '$allModels' extends keyof ExtArgs['model']
    ? ApplyAllModels extends true
      ? {
          [K in ModelNames]: PatchFlat3<
            ExtArgs['model'][K],
            ExtArgs['model']['$allModels'],
            PrevExtArgs['model'][K]
          >;
        }
      : {
          [K in
            | keyof ExtArgs['model']
            | keyof PrevExtArgs['model']]: PatchFlat3<
            ExtArgs['model'][K],
            PrevExtArgs['model'][K],
            {}
          >;
    ...
    : {
        [K in keyof ExtArgs['model'] | keyof PrevExtArgs['model']]: PatchFlat3<
          ExtArgs['model'][K],
          PrevExtArgs['model'][K],
          {}
        >;
  ...
  client: Pick_2<
    PatchFlat3<ExtArgs['client'], PrevExtArgs['client'], {}>,
    `$${string}`
  >;
  query: {};
};
...
declare class MergedExtensionsList {
  ...
  ): ModelExtensionDefinition | undefined;
...
declare namespace Types {
  export { Extensions_2 as Extensions, Utils };
}
export { Types };
