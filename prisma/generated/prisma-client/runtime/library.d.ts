...
export declare type BatchQueryOptionsCb = (
...
export declare type Client = ReturnType<
...
export declare type EngineEventType =
  | 'query'
  | 'info'
  | 'warn'
  | 'error'
...
export declare type GetFindResult<P extends Payload, A> = {} extends A
  ? DefaultSelection<P>
  : A extends
      | ({
...
export declare type RequiredArgs = NameArgs &
  ResultArgs &
  ModelArgs &
  ClientArgs &
  QueryOptions;
...
>(
  ...
  model: M,
  operation: O
): <S>(select: Exact<S, Args_3<C[M], O>>) => S;
...
>(
  ...
  operation: O,
  prop: P
): <S>(select: Exact<S, Args_3<C[M], O>[P]>) => S;
